//Scrape YouTube By SHINCHAN SENPAI
//Instagram: shinchan.senpai
//Tiktok : shinchan.senpai
//WhatsApp: +6282134110253
//GAUSAH RENAME ASU, LU GABISA BUAT BISA NYA RENAME😠
 ...
 class YT {
     ...
     static downloadMusic = async (query) => {
         try {
             ...
             let songPath = `./src/${randomBytes(3).toString('hex')}.mp3`
