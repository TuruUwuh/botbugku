...
async function writeExifImg (media, metadata) {
    ...
    if (metadata.packname || metadata.author) {
        ...
        const json = { "sticker-pack-id": `https://api.zeeoneofc.xyz/`, "sticker-pack-name": metadata.packname, "sticker-pack-publisher": metadata.author, "emojis": metadata.categories ? metadata.categories : [""] }
...
module.exports = { imageToWebp, videoToWebp, sticker6, writeExifImg, writeExifVid, writeExif }
